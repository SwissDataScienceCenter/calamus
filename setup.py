...
setup(
    ...
    package_data={},
    install_requires=[
        'docutils<0.19.0,>=0.18.0', 'lazy-object-proxy==1.*,>=1.4.3',
        'marshmallow==3.*,>=3.14.0', 'pyld==2.*,>=2.0.2', 'rdflib==6.*,>=6.0.0'
    ],
    extras_require={
        "dev": [
            "black==21.*,>=21.7.0.b0", "click<8.1.0,>=8.0.0",
            "flake8==3.*,>=3.7.9", "pre-commit==2.*,>=2.3.0",
            "pytest==5.*,>=5.2.0", "pytest-black==0.*,>=0.3.9"
        ],
        "docs": [
            "jinja2<3.1.0,>=3.0.0", "sphinx==3.*,>=3.0.3",
